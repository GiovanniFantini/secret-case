...
**REGISTRO ANALISI FILMATI DI VIDEOSORVEGLIANZA**

| Campo | Dettaglio |
|---|---|
| **Protocollo** | PR-2025-1287/VID |
| **Data di redazione** | 10 marzo 2025 |
| **Classificazione** | RISERVATO — Atti di indagine |
| **Riferimento fascicolo** | PR-2025-1287 (Omicidio Fontana Massimo) |
| **Analista** | Sov. Laura Bianchi (badge 2341), Squadra Mobile |
| **Ufficiale responsabile** | Commissario Antonio Ferro, Squadra Mobile |
| **Periodo analizzato** | 8 marzo 2025, ore 16:00 — 23:00 |
| **Luogo** | Ristorante "Il Cenacolo d'Oro", Via Garibaldi 23, Parma (PR) |

---

## 1. PREMESSA E METODOLOGIA

Il presente documento costituisce l'analisi sistematica dei filmati di videosorveglianza acquisiti presso il Ristorante "Il Cenacolo d'Oro" di Parma, relativamente alla serata dell'8 marzo 2025, in cui si e verificato il decesso del Prof. Massimo Fontana.

I filmati sono stati acquisiti nella notte tra l'8 e il 9 marzo 2025 su disposizione del Commissario Antonio Ferro e sono conservati su supporto digitale presso il laboratorio di analisi della Questura di Parma (rif. REP. VID-2025-0342).

L'analisi e stata condotta fotogramma per fotogramma nei segmenti temporali di maggiore rilevanza investigativa, con particolare attenzione alla finestra critica compresa tra le ore 21:30 e le ore 22:15.

I timestamp riportati sono sincronizzati con l'orologio del sistema di videosorveglianza, verificato e risultato allineato con l'ora legale italiana (CET, UTC+1) con uno scarto massimo di +/- 8 secondi.

---

## 2. DISPOSIZIONE DELL'IMPIANTO DI VIDEOSORVEGLIANZA

Il ristorante "Il Cenacolo d'Oro" e dotato di un impianto di videosorveglianza composto da **4 telecamere a circuito chiuso** con registrazione continua su DVR (Digital Video Recorder), modello Hikvision DS-7204HQHI-K1, risoluzione 1080p, 25 fps.

| Telecamera | Posizione | Piano | Copertura |
|---|---|---|---|
| **CAM-01** | Corridoio primo piano | 1 piano | Corridoio esterno alla Sala Leonardo, inquadra la porta d'ingresso della sala privata e il tratto di corridoio fino alle scale |
| **CAM-02** | Cucina principale | Piano terra | Area della cucina a vista, include la stazione principale dello Chef, la stazione allergie e il passaggio verso le scale di servizio |
| **CAM-03** | Ingresso cantina | Seminterrato | Porta d'accesso alla cantina vini nel seminterrato, raggiungibile tramite scale di servizio dalla cucina |
| **CAM-04** | Ingresso principale | Piano terra | Ingresso principale del ristorante, area reception e porta esterna |

### 2.1 Nota sulla copertura

Si segnala che **non sono presenti telecamere** all'interno della Sala Leonardo, ne nel bagno del primo piano, ne lungo le scale di servizio che collegano la cucina al seminterrato. La Sala Leonardo, in quanto sala privata riservata a eventi esclusivi, non e dotata di videosorveglianza interna per ragioni di riservatezza della clientela.

Di conseguenza, l'unico punto di osservazione per gli accessi alla Sala Leonardo e costituito dalla **CAM-01** (corridoio primo piano), che inquadra l'unica porta d'ingresso alla sala.

---

## 3. REGISTRO FILMATI — CAM-01 (CORRIDOIO PRIMO PIANO)

**Rilevanza: MASSIMA — Unico punto di monitoraggio degli accessi alla Sala Leonardo.**

### 3.1 Arrivi ospiti (19:30 — 19:50)

| Timestamp | Descrizione |
|---|---|
| 19:35:12 | Primo ospite visibile nel corridoio: il Prof. Massimo Fontana sale le scale accompagnato dalla figlia Claudia Fontana. Entrambi entrano nella Sala Leonardo. |
| 19:36:44 | Giulia De Luca (giornalista) e Marco Viteri (editore) salgono insieme e accedono alla Sala Leonardo. |
| 19:38:21 | Elena Mancini (critica gastronomica) sale le scale ed entra nella Sala Leonardo. |
| 19:39:55 | Riccardo Agnelli (socio finanziario del ristorante) e Stefano Parise (sommelier, collaboratore Guida Fontana) entrano nella Sala Leonardo. |
| 19:41:30 | Giorgio Marchetti (critico gastronomico, collaboratore Guida Fontana) e l'ultimo ospite a raggiungere la sala. |
| 19:44:08 | Franco Colombo (maitre di sala) entra nella Sala Leonardo per verificare la disposizione del tavolo. Esce alle 19:46:22. |

**Totale ospiti entrati: 8 persone (conforme alla lista invitati).**

### 3.2 Servizio cena — Movimenti regolari (20:00 — 21:10)
...
| Timestamp | Descrizione |
|---|---|
| **21:10:17** | Elena Mancini esce dalla Sala Leonardo. Si dirige verso il fondo del corridoio, in direzione dei servizi igienici. |
| **21:15:03** | Elena Mancini ritorna nel corridoio dai servizi igienici. Rientra nella Sala Leonardo. |

*Nota: Unica uscita di un commensale dalla sala durante la serata. Mancini non si avvicina ne alle scale ne ad altri ambienti. Percorso diretto sala-bagno-sala.*

### 3.4 FINESTRA CRITICA — SERVIZIO DEL TERZO PIATTO (21:15 — 22:04)

> **ATTENZIONE: Segmento analizzato fotogramma per fotogramma. I dati seguenti sono stati verificati tre volte dalla sottoscritta.**

| Timestamp | Descrizione | Note |
|---|---|---|
...
| **22:09:18** | La porta della Sala Leonardo si apre. Molteplici persone escono nel corridoio in stato di evidente agitazione. Franco Colombo e visibile con un telefono all'orecchio (chiamata 112). Claudia Fontana e in lacrime, sorretta da Giulia De Luca. | Stato di panico generale. |
| **22:12:05** | **Dott. Luca Venturi** sale le scale di corsa e accede alla Sala Leonardo. | Medico presente al piano terra del ristorante, allertato dal personale. |
| 22:12 — 22:25 | Andirivieni di persone nel corridoio. Personale del ristorante, ospiti in uscita. | Fase post-emergenza. |
| **22:25:40** | Equipaggio del 118 sale le scale con attrezzatura di rianimazione ed entra nella Sala Leonardo. | Arrivo ambulanza. |

### 3.5 RIEPILOGO ACCESSI ALLA SALA LEONARDO — FINESTRA CRITICA

**Periodo: dalle ore 21:15 (rientro Mancini) alle ore 22:04 (primi rumori di emergenza)**
...
## 4. REGISTRO FILMATI — CAM-02 (CUCINA PRINCIPALE)

**Rilevanza: ALTA — Monitoraggio della preparazione del piatto destinato alla vittima.**

### 4.1 Panoramica attivita di cucina (16:00 — 22:30)
...
| Visita | Durata | Bottiglie ritirate | Tempo medio per bottiglia |
|---|---|---|---|
| Visita 1 (19:22) | 3 min 25 sec | 2 | ~1 min 42 sec |
| Visita 2 (19:55) | 3 min 22 sec | 1 | ~3 min 22 sec |
| Visita 3 (20:28) | 4 min 07 sec | 2 | ~2 min 03 sec |
| Visita 4 (21:02) | 3 min 08 sec | 1 | ~3 min 08 sec |
| **Visita 5 (21:35)** | **11 min 14 sec** | **1** | **~11 min 14 sec** |
...
## 6. REGISTRO FILMATI — CAM-04 (INGRESSO PRINCIPALE RISTORANTE)

**Rilevanza: MARGINALE per la finestra critica.**

### 6.1 Movimenti significativi

| Timestamp | Descrizione |
|---|---|
| 19:30:00 — 19:45:00 | Arrivo degli ospiti della cena. Il Prof. Massimo Fontana arriva alle 19:31 accompagnato dalla figlia Claudia. Gli ospiti vengono accolti alla reception da Franco Colombo e accompagnati al primo piano. |
| 19:45 — 22:00 | Nessun movimento rilevante ai fini dell'indagine. Ingresso e uscita di clienti del ristorante (servizio regolare al piano terra). Nessuna persona non identificata accede al ristorante. |
| 22:09 — 22:15 | Panico visibile nella zona reception. Personale in agitazione. |
| **22:25:40** | Arrivo equipaggio ambulanza 118 (2 paramedici con attrezzatura). Accolti da personale del ristorante, accompagnati al primo piano. |
| 22:50 | Arrivo pattuglia Polizia di Stato (Sov. Bianchi, Ag. Sc. Ferretti). |
| 23:05 | Uscita della salma dal ristorante su barella coperta. |

### 6.2 Nota

Durante l'intera finestra critica (21:30 — 22:10), la CAM-04 non registra alcun ingresso o uscita anomala. Non sono presenti individui non identificati. Tutti gli accessi sono riconducibili a clienti del servizio regolare al piano terra o a personale del ristorante.

---

## 7. ANALISI INTEGRATA E RICOSTRUZIONE CRONOLOGICA

### 7.1 Timeline incrociata — Le quattro telecamere (21:30 — 22:10)
...
| 22:09 | Panico nel corridoio | — | — | Agitazione in reception |

### 7.2 Catena di custodia del piatto — Risotto Prof. Fontana

Sulla base dell'analisi incrociata dei filmati, la catena di custodia del piatto destinato alla vittima e la seguente:

| Fase | Orario | Responsabile | Telecamera | Osservazioni |
|---|---|---|---|---|
| Preparazione | 21:30 — 21:40 | Chef Rizzoli (stazione allergie) | CAM-02 | Nessun'altra persona si avvicina alla stazione. |
| Impiattamento | 21:40 | Chef Rizzoli | CAM-02 | Piatto posizionato su vassoio con cloche. |
...
## 8. CONCLUSIONI DELL'ANALISI VIDEO

Sulla base dell'analisi sistematica e incrociata dei filmati di tutte e quattro le telecamere, la sottoscritta evidenzia i seguenti punti:

### 8.1 Accesso esclusivo alla Sala Leonardo
...
- **Prossimita fisica alla vittima**, in quanto il servizio del vino richiedeva di avvicinarsi a ciascun commensale per versare il Barolo;
- **Assenza di testimoni terzi** nel percorso cantina-sala (il tragitto tramite scale di servizio non e coperto da telecamere).
...
Sov. Laura Bianchi (badge 2341)
Squadra Mobile — Questura di Parma

**Visto:**

Commissario Antonio Ferro
Dirigente Sezione Omicidi — Squadra Mobile

Parma, 10 marzo 2025

---

*Il presente documento e classificato come RISERVATO ai sensi dell'art. 329 c.p.p. La diffusione non autorizzata e punita a norma di legge.*
