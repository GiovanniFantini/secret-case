...
- [Professione/Occupazione principale]
- [Storia professionale dettagliata]
- [Successi, realizzazioni, posizione sociale]
...
- [Pregi e difetti]
- [Comportamenti rilevanti per il caso]
...
**Condizione medica/fisica rilevante:**
- [Allergie, malattie, debolezze fisiche che sono state sfruttate]
- [Informazioni mediche pertinenti al caso]
- [Chi era a conoscenza di queste condizioni]

---

## 3. Circostanze della Scoperta

**Dove:** [Luogo preciso, descrizione dell'ambiente]

**Quando:** [Data e ora esatta della scoperta]

**Chi ha trovato il corpo/scoperto il crimine:** [Nome e ruolo della persona]

**Stato della scena:**
- [Posizione del corpo o evidenze del crimine]
- [Condizioni ambientali]
- [Oggetti presenti/fuori posto]
- [Segni di colluttazione o altre evidenze]
...
- [Descrizione dettagliata del rapporto]
- [Storia della relazione: come si sono conosciuti, evoluzione nel tempo]
- [Tensioni, conflitti, o legami particolari]
- [Cosa sapeva la vittima su questo sospetto]
...
- [Testimoni che supportano l'alibi]
- [Dettagli temporali forniti]
- [Prove a supporto (telecamere, ricevute, etc.)]
...
- [Storia ed evoluzione del rapporto]

**Movente apparente:**
- [Primo livello di movente visibile]
- [Evidenze supportive]

**Alibi dichiarato:**
- [Alibi fornito all'interrogatorio]
- [Testimoni e prove]
...
[Aggiungere altri sospettati se necessario con la stessa struttura]
...
[Paragrafo 1: Cosa ha innescato la decisione di uccidere]
...
- [Documento 1]: [Cosa rivela]
- [Documento 2]: [Cosa rivela]
- [Documento 3]: [Cosa rivela]
...
1. [Passo 1 della preparazione con data/periodo]
   - Documento probatorio: [Nome file]
   - Indizio: [Cosa devono notare i giocatori]

2. [Passo 2 della preparazione]
   - Documento probatorio: [Nome file]
   - Indizio: [Cosa devono notare i giocatori]

3. [Continuare per tutti i passi preparatori]

**Esecuzione (giorno del crimine):**
1. [Ora precisa] - [Azione del colpevole]
   - Documento probatorio: [Nome file]
   - Testimone: [Se applicabile]
   - Telecamere: [Se applicabile]

2. [Ora precisa] - [Azione successiva]
   - [Dettagli]

3. [Continuare fino all'atto finale del crimine]
...
**Dopo il crimine:**
1. [Cosa ha fatto il colpevole immediatamente dopo]
2. [Come ha eliminato le prove]
3. [Come ha costruito l'alibi]
4. [Errori commessi che hanno lasciato indizi]

---

### 5.4 - La Catena Probatoria

Questi sono gli indizi chiave che i giocatori devono collegare per risolvere il caso:

#### Indizi Diretti (30%)
Prove evidenti che puntano direttamente al colpevole:

1. **[Nome indizio]**
   - Descrizione: [Cosa dimostra]
   - Trovabile in: `[nome-file.md]` - Sezione "[Nome sezione]"
   - Importanza: [Alta / Media / Bassa]
   - Tipo: [Testimonianza / Prova fisica / Documento / Digitale]

2. **[Nome indizio]**
   - [Stessa struttura]

[Continuare per tutti gli indizi diretti]

#### Indizi da Collegare (40%)
Prove che acquistano significato solo se collegate tra loro:

1. **[Nome indizio A] + [Nome indizio B]**
   - Descrizione collegamento: [Cosa rivelano insieme]
   - Indizio A in: `[nome-file.md]` - [Dettaglio]
   - Indizio B in: `[altro-file.md]` - [Dettaglio]
   - Cosa dovrebbero dedurre: [Conclusione]

2. **[Nome indizio C] + [Nome indizio D] + [Nome indizio E]**
   - [Stessa struttura per collegamenti multipli]

[Continuare per tutti i collegamenti necessari]

#### Indizi Nascosti (20%)
Prove sottili che richiedono attenzione ai dettagli:
...
[Continuare per tutte le false piste]

---

### 5.5 - Timeline Completa degli Eventi

**[Data - X giorni prima del crimine]**
- [HH:MM] - [Evento rilevante per la preparazione]
- [HH:MM] - [Altro evento]

**[Data - Y giorni prima del crimine]**
- [Eventi della preparazione]

**[Data del crimine]**
- [HH:MM] - [Evento 1]
- [HH:MM] - [Evento 2]
- [HH:MM] - **CRIMINE COMMESSO**
- [HH:MM] - [Evento dopo il crimine]
- [HH:MM] - [Scoperta del corpo/crimine]

---

### 5.6 - Contraddizioni e Bugie

Elementi chiave che i giocatori devono identificare come falsi:
...
#### Bugia 2 del Colpevole
[Stessa struttura]

[Continuare per tutte le bugie significant]
...
### Falsa Pista 2: [Titolo]
[Stessa struttura dettagliata]

### Falsa Pista 3: [Titolo]
[Stessa struttura dettagliata]
...
- **Se scelgono B:** "No. [Nome Sospetto 2] [spiegazione]"
- **Se scelgono D:** "No. [Nome Sospetto 4] [spiegazione]"
...
|-----------------|-------------|--------|----------|
| Indizi diretti | 30% | [N] | Puntano chiaramente al colpevole |
| Indizi da collegare | 40% | [N] | Richiedono connessione tra documenti |
| Indizi nascosti | 20% | [N] | Dettagli sottili che confermano |
| Red herring | 10% | [N] | False piste intenzionali |
...
1. Rileggere documenti chiave per confermare teoria
2. Verificare che tutti gli indizi siano spiegati
3. Prepararsi a rispondere alle 3 domande
...
**Obbligatori:**
- [ ] Tutti i documenti stampati (o cartella digitale organizzata)
- [ ] Sistema di verifica configurato (Google Form o buste fisiche)
- [ ] Script narrazione finale pronto (stampato o registrato audio)
- [ ] Suggerimenti in buste separate numerate

**Opzionali ma consigliati:**
- [ ] Playlist musicale atmosferica
- [ ] Foto/immagini della scena del crimine
- [ ] Props fisici (se applicabili al caso)
- [ ] Timer per checkpoint temporali

### Durante il Gioco

**Checkpoint temporali da dare ai giocatori:**
- Dopo 30 min: "[Domanda checkpoint Fase 1]"
- Dopo 90 min: "[Domanda checkpoint Fase 2]"
- Dopo 120 min: "[Domanda checkpoint Fase 3]"

**Quando dare i suggerimenti:**
- Livello 1: Se dopo [X] minuti non hanno identificato sospetti principali
- Livello 2: Se dopo [Y] minuti non riescono a collegare movente e metodo
...
1. Far leggere/ascoltare la narrazione finale
2. Discutere gli indizi persi
3. Rispondere alle domande sul caso
4. Raccogliere feedback per migliorare
...
- Giocatori esperti: [X] ore
- Prima esperienza: [Y] ore
- Con suggerimenti: [Z] ore
...
- **2-3 giocatori**: [Esperienza ottimale]
- **4+ giocatori**: [Come gestire gruppo grande]
...
**Changelog:**
- v[X.Y] - [Data] - [Modifiche]
- v[X.Y-1] - [Data] - [Modifiche precedenti]
